                    ...
                    <div>
                        <div className={styles.text}>
                            ...
                            <p>
                                ...
                                This is a mock e-commerce website consuming this <a href='https://fakestoreapi.com/' target='_blank'>API</a>. Check out the <a href='https://github.com/vtmattedi/EShop' target='_blank'>github</a> repository for more information.
                            </p>
                            <p>
